...
class HomePage extends React.Component {
  render() {
    ...
    const isPittsburgh = window.location.href
      .toLowerCase()
      .includes("pittsburgh");
    ...
    return (
      <div style={styles.home}>
          ...
          >
            ...
            >
              ...
              <div style={styles.serviceContainer}>
                ...
                <div style={styles.serviceDescription}>
                  We host weekly, FREE, video calls anyone can join to get
                  advice or help on anything related to React Native. Click{" "}
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                DJCity has streaming music players in the App Store and Googe
                Play. We rewrote their existing iOS app in React Native for
                release in the App store and Google Play. DJCity now has a
                stable, modern app platform to build from.
                <br />
                <br />
                Streaming Audio <br />
                iOS and Android <br />
        ...
        >
          ...
          >
            <div style={{ justifyContent: "center", display: "flex" }}>
              <img style={{ marginTop: "-10px", height: "510px" }} src={irc} />
            </div>
            <div
              style={{
                width: small ? "100%" : "400px",
            ...
            >
              ...
              >
                Parsed partnered with the award winning design agency{" "}
                <a href="https://isl.co/">ISL</a> to build a mobile app that
                helps refugees during their resettlement journey to the United
                States.
                <br />
                <br />
              ...
              >
                <a href="https://itunes.apple.com/us/app/settle-in/id1353000516?mt=8">
                  <img
                    src={appStore}
                    style={{ justifyContent: "center", alignSelf: "center" }}
                  />
                </a>
                <a href="https://play.google.com/store/apps/details?id=com.irc.settlein">
                  <img
                    style={{ width: "152px" }}
          ...
          >
            ...
            >
              ...
              >
                <a
                  style={{ color: "#CCE8FF" }}
                  href="https://calendly.com/caseygarland"
                >
                  Schedule
                </a>{" "}
                a free 30 minute consultation to see if we're the right fit.{" "}
                <br />
                Not ready for a call? Shoot us an email{" "}
                <a
                  style={{ textDecoration: "none", color: "#CCE8FF" }}
                  href="mailTo:hi@parsed.io"
                >
                  hi@parsed.io
                </a>.
              </div>
            ...
            >
              ...
              Copyright 2017 Parsed, LLC &#9679; A Mobile App Design and
              Development Company &#9679; All Rights Reserved &#9679; Built in
              PGH
            </div>
          </div>
        </div>
